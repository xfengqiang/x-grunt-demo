var define2 = define("app/index/index-debug", [ "lib/jquery/jquery/1.8.2/jquery-debug", "common/dialog/dialog-debug", "jquery-debug", "common/dialog/dialog_css-debug.css" ], function(require, exports) {
 ...
 */
define("app/topic/index-debug", [ "lib/jquery/jquery/1.8.2/jquery-debug", "common/dialog/dialog-debug", "jquery-debug", "common/dialog/dialog_css-debug.css" ], function(require, exports) {
    var $ = require("lib/jquery/jquery/1.8.2/jquery-debug"), Dialog = require("common/dialog/dialog-debug");
    $("#btnDialog").bind("click", function() {
        var mapDialog = new Dialog({
            type: "text",
